      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-center max-w-7xl mx-auto">
          ...
          <FadeIn>
            ...
            <h2 className="text-6xl md:text-[5.5rem] font-black tracking-tighter text-white mb-10 leading-[0.85]">
              Zéro Compromis. <br />
              <span className="text-green-400">Sécurité B2B.</span>
            </h2>
            <p className="text-white/40 text-xl leading-relaxed max-w-xl font-medium mb-12">
            ...
            <div className="flex items-center gap-8 border-t border-white/10 pt-12">
              <div className="flex flex-col">
                <span className="text-white font-black text-4xl mb-1">99.9%</span>
                <span className="text-[10px] uppercase tracking-widest text-white/30 font-bold">Uptime Sévère</span>
              </div>
              <div className="w-[1px] h-12 bg-white/10" />
              <div className="flex flex-col">
                <span className="text-white font-black text-4xl mb-1">256bit</span>
          ...
          <div className="relative">
              ...
              {features.map((f, idx) => (
                <FadeIn key={idx} delay={0.1 * idx}>
                  <motion.div 
                    ...
                    className="h-full p-8 bg-white/[0.03] rounded-[2.5rem] border border-white/5 hover:border-green-500/30 hover:bg-green-500/5 transition-all duration-500 group"
                  >
            ...
            <motion.div 
              ...
              className="absolute -bottom-10 -right-10 hidden lg:flex items-center gap-3 px-6 py-3 rounded-2xl bg-surface border border-white/10 shadow-2xl backdrop-blur-xl"
            >
              <Cpu size={16} className="text-green-400" />
              <span className="text-[10px] font-black uppercase tracking-widest text-white">Encrypted Core</span>
            </motion.div>
          </div>
