...
/**
 * FEATURE BUTTON COMPONENT - REFINED
 */
const FeatureTab = ({ active, onClick, icon: Icon, label, desc }: any) => (
  <button
    onClick={onClick}
    className={`w-full group flex items-start gap-5 p-7 rounded-[2.5rem] transition-all duration-700 text-left border-2 ${
      active 
        ...
        : "bg-surface/30 border-white/5 opacity-50 hover:opacity-100 hover:bg-surface/50"
    }`}
  >
    ...
    <div className="flex-1">
      <h4 className={`font-black text-xl mb-1.5 flex items-center gap-2 ${active ? "text-white" : "text-text-muted opacity-80"}`}>
        {label}
      </h4>
...
export const SaaSPlatformSection = () => {
  ...
  return (
    <section className="py-32 md:py-64 bg-[#050505] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center lg:text-left">
        ...
        <div className="flex flex-col lg:flex-row items-end justify-between gap-12 mb-32 max-w-7xl mx-auto">
          <FadeIn className="max-w-3xl text-center lg:text-left">
            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-accent/10 border border-accent/20 text-accent mb-10">
              <Monitor size={14} />
            ...
            <h2 className="text-6xl md:text-[8rem] font-black tracking-tighter leading-[0.8] mb-12">
              Pilotez votre <br />
              <span className="text-white opacity-40">Impact</span> <span className="text-accent italic">Réseau.</span>
            </h2>
          ...
          <FadeIn delay={0.2} className="hidden lg:flex gap-8 border-l border-white/10 pl-12 h-32 items-center">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-stretch max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <FadeIn className="space-y-4">
              <FeatureTab 
                ...
                desc="Intelligence prédictive et analytics de conversion. Mesurez le ROI exact de chaque salon et rencontre."
              />
              <FeatureTab 
              ...
              <FeatureTab 
                ...
                desc="Leads qualifiés synchronisés vers HubSpot, Pipedrive et Salesforce sans aucune saisie manuelle."
              />
            </FadeIn>
          </div>

          {/* RIGHT COLUMN: INTERACTIVE WINDOW */}
          <div className="lg:col-span-8 relative min-h-[600px] lg:h-[750px]">
            <FadeIn delay={0.2} className="h-full">
                        ...
                        >
                          <div className="p-10 border-r border-white/5 bg-[#0a0a0b]/50 overflow-y-auto">
                             ...
                             <div className="space-y-10">
                                <div className="space-y-4">
                                   <label className="text-[10px] font-black uppercase text-text-muted tracking-widest">Matériau de la Carte</label>
                                ...
                                <div className="space-y-4">
                                   <label className="text-[10px] font-black uppercase text-text-muted tracking-widest">Action par défaut</label>
                          ...
                          <div className="relative flex flex-col items-center justify-center p-8 bg-black overflow-hidden">
                             ...
                             <motion.div 
                               ...
                               className="relative group mb-12 z-10"
                             >
                             ...
                             <motion.div 
                               ...
                               className="absolute bottom-10 right-10 w-44 h-[350px] bg-black rounded-[2rem] border-[4px] border-[#1a1a1a] shadow-2xl overflow-hidden hidden md:block z-20"
                             >
                                <div className="absolute top-2 left-1/2 -translate-x-1/2 w-16 h-3 bg-black rounded-full z-10" />
                                <div className="h-20 bg-accent/30" />
                                <div className="flex flex-col items-center p-4">
                                   <div className="w-14 h-14 rounded-full border-4 border-black -mt-7 bg-[#111] overflow-hidden"><img src="/profile.jpg" className="w-full h-full object-cover" /></div>
                                   <div className="text-[10px] font-black mt-3 text-white">Lucas Gomes</div>
                                   <div className="text-[8px] text-accent font-bold mb-4 uppercase tracking-widest">Founder</div>
                                   <div className="w-full h-9 bg-accent/20 border border-accent/20 rounded-xl flex items-center justify-center"><div className="w-12 h-1.5 bg-accent rounded-full" /></div>
                        ...
                        >
                           <div className="grid grid-cols-12 gap-8 h-full">
                              <div className="col-span-12 lg:col-span-7 space-y-12">
                                 <div className="space-y-4">
                                    <h5 className="text-3xl font-black text-white italic">CRM Sync Engine</h5>
                                    <p className="text-sm text-text-muted font-medium">Injection automatique des leads qualifiés.</p>
                                 </div>
                                 ...
                                 <div className="relative flex items-center justify-between gap-4 p-10 bg-[#0a0a0b] rounded-[2.5rem] border border-white/5 shadow-2xl">
                                    ...
                                    {[
                                      ...
                                      <div key={i} className="relative z-10 flex flex-col items-center gap-4">
                                         ...
                                         <span className="text-[10px] font-black uppercase tracking-widest text-text-muted">{step.label}</span>
                                      </div>
                                    ))}
                                 </div>
                              ...
                              <div className="col-span-12 lg:col-span-5 bg-[#0a0a0b] border border-white/5 rounded-[2.5rem] p-8 flex flex-col shadow-2xl">
                                 ...
                                 <div className="space-y-4">
                                    {[
                                      ...
                                      <motion.div 
                                        ...
                                        key={i} 
                                        className="p-4 rounded-xl bg-white/5 border border-white/5 flex items-center justify-between group hover:bg-white/10 transition-colors"
                                      >
                                         <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-lg bg-surface flex items-center justify-center text-[10px] font-black text-white/20 uppercase">{lead.name[0]}</div>
                                            <div>
                                               <div className="text-[10px] font-black text-white">{lead.name}</div>
                                               <div className="text-[8px] text-text-muted font-medium">{lead.company}</div>
                                            </div>
                                         </div>
                                         <div className="text-right">
                                            <div className="text-[9px] font-black text-accent uppercase tracking-tighter">{lead.score} pts</div>
                                         </div>
                                      </motion.div>
                                    ))}
                                 </div>
                                 ...
                                 <div className="mt-auto pt-6 text-center">
                                    <span className="text-[9px] font-black text-white/20 uppercase tracking-widest cursor-pointer hover:text-white transition-colors">Explorer tout l'historique</span>
                                 </div>
                              </div>
                           </div>
                        </motion.div>
                        ...
                        >
                           <div className="flex justify-between items-end mb-12">
                              <div>
                                 ...
                                 <p className="text-sm text-text-muted font-medium">Monitoring prédictif activé.</p>
                              </div>
                              ...
                              <div className="col-span-12 lg:col-span-8 bg-[#0a0a0b] rounded-[2.5rem] border border-white/5 p-10 flex flex-col shadow-2xl">
                                 <div className="flex justify-between items-center mb-10">
                                    ...
                                    <div className="flex gap-6">
                                       ...
                                       <div className="text-[10px] font-bold text-text-muted">ANNUEL</div>
                                    </div>
                                 </div>
               ...
               <div className="absolute -top-6 -right-6 px-6 py-4 bg-accent rounded-2xl text-[10px] font-black text-white uppercase tracking-widest shadow-2xl rotate-3 border-4 border-[#050505] z-30">Live Syncing</div>
               <div className="absolute -bottom-6 -left-6 px-6 py-4 bg-white rounded-2xl text-[10px] font-black text-black uppercase tracking-widest shadow-2xl -rotate-3 border-4 border-[#050505] z-30">B2B Optimized</div>
            </FadeIn>
          </div>
        </div>
      </div>
