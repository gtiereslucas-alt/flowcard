            ...
            <div className="sticky top-0 h-[100dvh] w-full overflow-hidden flex flex-col lg:flex-row items-center justify-center pt-16 sm:pt-20 lg:pt-0">
                ...
                <div className="w-full h-[40vh] sm:h-[45vh] lg:h-full lg:w-1/2 flex items-center justify-center relative z-20 px-4 md:px-8 lg:px-16">
                    ...
                    >
                        ...
                        <h2 className="text-5xl sm:text-7xl lg:text-[7rem] font-black tracking-tighter text-foreground leading-[0.9]">
                    ...
                    >
                        ...
                        <h2 className="text-5xl sm:text-7xl lg:text-[7rem] font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-accent via-blue-400 to-cyan-300 leading-[0.9]">
                            Connectez <br/>
                    ...
                    >
                        ...
                        <h2 className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tighter text-foreground leading-[0.9] mb-3 lg:mb-6">
                            C'est <br/>
                ...
                <div className="w-full h-[55vh] lg:h-full lg:w-1/2 flex items-center justify-center relative z-10 translate-y-8 sm:translate-y-12 lg:translate-y-0">
                    ...
                    <FadeIn delay={0.2} duration={1}>
                        <div className="relative w-[240px] sm:w-[280px] lg:w-[340px] h-[480px] sm:h-[560px] lg:h-[680px] bg-black rounded-[2.5rem] lg:rounded-[3.5rem] border-[6px] lg:border-[10px] border-[#1a1a1a] dark:border-[#111] shadow-[0_40px_100px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col transform-gpu">
                            ...
                            {/* Dynamic Island */}
                            <div className="absolute top-2 lg:top-3 left-1/2 -translate-x-1/2 w-[80px] lg:w-[100px] h-[20px] lg:h-[26px] bg-black rounded-full z-40 flex items-center justify-between px-2 shadow-sm border border-white/5">
                            ...
                            <motion.div 
                                ...
                                className="absolute inset-0 w-full h-full bg-surface dark:bg-[#050505] flex flex-col pt-10 lg:pt-14 z-30"
                            >
